...
namespace DVLBLL.License
{
    public class clsDetainedLicense
    {
        ...
        public ManageUserBLL CreatedByUserInfo { set; get; }
        public bool IsReleased { set; get; }
        public DateTime ReleaseDate { set; get; }
        public int ReleasedByUserID { set; get; }
        public ManageUserBLL ReleasedByUserInfo { set; get; }
...

        {
            ...
            this.CreatedByUserInfo = ManageUserBLL.FindUserByID(this.CreatedByUserID);
            this.IsReleased = IsReleased;
            this.ReleaseDate = ReleaseDate;
            this.ReleasedByUserID = ReleasedByUserID;
            this.ReleaseApplicationID = ReleaseApplicationID;
            this.ReleasedByUserInfo = ManageUserBLL.FindByPersonID(this.ReleasedByUserID);
            Mode = enMode.Update;
        }
